...
_lr_productions = [
  ...
  ('statement_list -> statement statement_nullable','statement_list',2,'p_statement_list','Parser.py',18),
  ('statement_nullable -> statement statement_nullable','statement_nullable',2,'p_statement_nullable','Parser.py',27),
  ('statement_nullable -> empty','statement_nullable',1,'p_statement_nullable','Parser.py',28),
  ('statement -> declaration_statement','statement',1,'p_statement','Parser.py',39),
  ('declaration_statement -> DCL declaration_list SEMI','declaration_statement',3,'p_declaration_statement','Parser.py',44),
  ('declaration_list -> declaration','declaration_list',1,'p_declaration_list','Parser.py',48),
  ('declaration_list -> declaration COMMA declaration','declaration_list',3,'p_declaration_list','Parser.py',49),
  ('declaration -> identifier_list mode','declaration',2,'p_declaration','Parser.py',59),
  ('identifier_list -> ID','identifier_list',1,'p_identifier_list','Parser.py',63),
  ('identifier_list -> ID COMMA identifier_list','identifier_list',3,'p_identifier_list','Parser.py',64),
  ('mode -> discrete_mode','mode',1,'p_mode','Parser.py',81),
  ('discrete_mode -> integer_mode','discrete_mode',1,'p_discrete_mode','Parser.py',84),
  ('discrete_mode -> boolean_mode','discrete_mode',1,'p_discrete_mode','Parser.py',85),
  ('discrete_mode -> character_mode','discrete_mode',1,'p_discrete_mode','Parser.py',86),
  ('integer_mode -> INT','integer_mode',1,'p_integer_mode','Parser.py',90),
  ('boolean_mode -> BOOL','boolean_mode',1,'p_boolean_mode','Parser.py',93),
  ('character_mode -> CHAR','character_mode',1,'p_character_mode','Parser.py',96),
